// import {iOTokenBase, iAssetsWithoutETH, ITestEnvWithoutInstances, RateMode} from '../utils/types';
// import {
...
//   let _oTokenInstances: iOTokenBase<OTokenInstance>;
...
//   it('Tries to invoke redeemUnderlying on an reserve, from a non-oToken address', async () => {
//     await expectRevert(
//       _lendingPoolInstance.redeemUnderlying(ETHEREUM_ADDRESS, deployer, '1', '0'),
//       'The caller of this function can only be the oToken contract of this reserve'
//     );
//   });
...
//     const {aWETH, aDAI} = _oTokenInstances;
