...
import { strategyWETH } from '../../markets/omnidex/reservesConfigs';
...
makeSuite('LendingPoolConfigurator', (testEnv: TestEnv) => {
  ...
  it('Check the onlyOmniDexAdmin on deactivateReserve ', async () => {
  ...
  it('Check the onlyOmniDexAdmin on activateReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on freezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on unfreezeReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on disableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on enableBorrowingOnReserve ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on configureReserveAsCollateral ', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
      configurator
  ...
  it('Check the onlyOmniDexAdmin on disableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
  ...
  it('Check the onlyOmniDexAdmin on enableReserveStableRate', async () => {
    const { configurator, users, weth } = testEnv;
    await expect(
